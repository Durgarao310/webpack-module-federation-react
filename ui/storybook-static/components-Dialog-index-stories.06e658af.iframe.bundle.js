/*! For license information please see components-Dialog-index-stories.06e658af.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunkui=self.webpackChunkui||[]).push([[295],{"../node_modules/react/cjs/react-jsx-runtime.production.js":(__unused_webpack_module,exports)=>{var REACT_ELEMENT_TYPE=Symbol.for("react.transitional.element"),REACT_FRAGMENT_TYPE=Symbol.for("react.fragment");function jsxProd(type,config,maybeKey){var key=null;if(void 0!==maybeKey&&(key=""+maybeKey),void 0!==config.key&&(key=""+config.key),"key"in config)for(var propName in maybeKey={},config)"key"!==propName&&(maybeKey[propName]=config[propName]);else maybeKey=config;return config=maybeKey.ref,{$$typeof:REACT_ELEMENT_TYPE,type,key,ref:void 0!==config?config:null,props:maybeKey}}exports.Fragment=REACT_FRAGMENT_TYPE,exports.jsx=jsxProd,exports.jsxs=jsxProd},"../node_modules/react/jsx-runtime.js":(module,__unused_webpack_exports,__webpack_require__)=>{module.exports=__webpack_require__("../node_modules/react/cjs/react-jsx-runtime.production.js")},"./src/components/Button/index.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{A:()=>components_Button});var jsx_runtime=__webpack_require__("../node_modules/react/jsx-runtime.js"),react=__webpack_require__("../node_modules/react/index.js"),styled_components_browser_esm=__webpack_require__("../node_modules/styled-components/dist/styled-components.browser.esm.js");const StyledButton=styled_components_browser_esm.Ay.button`
  display: inline-flex;
  align-items: center;
...
`,DialogOverlay=styled_components_browser_esm.Ay.div`
  position: fixed;
  inset: 0;
...
`,DialogBody=styled_components_browser_esm.Ay.div`
  padding: ${({theme})=>theme.spacing.md};
...
`,Dialog=(styled_components_browser_esm.Ay.button`
  position: absolute;
  ...
  cursor: pointer;
  font-size: 1.25rem;
`,({isOpen,onClose,header,children,footer})=>isOpen?(0,jsx_runtime.jsx)(DialogOverlay,{onClick:onClose,children:(0,jsx_runtime.jsxs)(DialogContainer,{onClick:e=>e.stopPropagation(),children:[header&&(0,jsx_runtime.jsx)(DialogHeader,{children:header}),(0,jsx_runtime.jsx)(DialogBody,{children}),footer&&(0,jsx_runtime.jsx)(DialogFooter,{children:footer})]})}):null),components_Dialog=Dialog;Dialog.__docgenInfo={description:"",methods:[],displayName:"Dialog",props:{isOpen:{required:!0,tsType:{name:"boolean"},description:""},onClose:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},header:{required:!1,tsType:{name:"ReactNode"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""},footer:{required:!1,tsType:{name:"ReactNode"},description:""},title:{required:!1,tsType:{name:"string"},description:""}}};var Button=__webpack_require__("./src/components/Button/index.tsx");const index_stories={title:"UI/Dialog",component:components_Dialog,tags:["autodocs"],args:{isOpen:!0,header:"Dialog Header",children:"Dialog Body",footer:(0,jsx_runtime.jsx)(Button.A,{children:"Close"})}},Default={args:{}},__namedExportsOrder=["Default"];Default.parameters={...Default.parameters,docs:{...Default.parameters?.docs,source:{originalSource:"{\n  args: {}\n}",...Default.parameters?.docs?.source}}}}}]);
//# sourceMappingURL=components-Dialog-index-stories.06e658af.iframe.bundle.js.map